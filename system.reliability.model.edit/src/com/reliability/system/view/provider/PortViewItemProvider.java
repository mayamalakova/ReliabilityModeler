 ...
 * @generated
 */
public class PortViewItemProvider
	 ...
	 * @generated
	 */
	public PortViewItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PortView"));
	}
	...
	public String getText(Object object) {
		String label = ((PortView)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_PortView_type") :
			getString("_UI_PortView_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PortView.class)) {
