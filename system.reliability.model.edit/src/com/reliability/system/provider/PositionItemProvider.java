...
/**
 * This is the item provider adapter for a {@link com.reliability.system.Position} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PositionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Position_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Position_id_feature", "_UI_Position_type"),
				 SystemPackage.Literals.POSITION__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Position)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Position.class)) {
			case SystemPackage.POSITION__ID:
