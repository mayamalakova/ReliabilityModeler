...
public class SystemExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.system"));
				Transition root = SystemFactory.eINSTANCE.createTransition();
