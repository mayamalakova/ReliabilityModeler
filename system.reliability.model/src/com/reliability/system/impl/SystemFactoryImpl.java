...
public class SystemFactoryImpl extends EFactoryImpl implements SystemFactory {
	...
	public static SystemFactory init() {
		try {
			SystemFactory theSystemFactory = (SystemFactory)EPackage.Registry.INSTANCE.getEFactory("system.reliability.model"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SystemPackage.TRANSITION: return createTransition();
			case SystemPackage.TRANSITION_MATRIX_ELEMENT: return createTransitionMatrixElement();
			case SystemPackage.GENERALIZED_NET: return createGeneralizedNet();
			case SystemPackage.PORT: return createPort();
			case SystemPackage.FAILURE: return createFailure();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case SystemPackage.POSITION_TYPE:
				return createPositionTypeFromString(eDataType, initialValue);
			case SystemPackage.TRANSITION_TYPE:
	 ...
	 * @generated
	 */
	public TransitionMatrixElement createTransitionMatrixElement() {
		TransitionMatrixElementImpl transitionMatrixElement = new TransitionMatrixElementImpl();
		return transitionMatrixElement;
	}
	 ...
	 * @generated
	 */
	public GeneralizedNet createGeneralizedNet() {
		GeneralizedNetImpl generalizedNet = new GeneralizedNetImpl();
