...
public class SystemAdapterFactory extends AdapterFactoryImpl {
	...
	protected SystemSwitch<Adapter> modelSwitch =
		new SystemSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTransitionMatrixElement(TransitionMatrixElement object) {
				return createTransitionMatrixElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.reliability.system.TransitionMatrixElement <em>Transition Matrix Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
