...
public class ViewSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ViewPackage.TRANSITION_VIEW: {
			...
			case ViewPackage.PORT_VIEW: {
				PortView portView = (PortView)theEObject;
				T result = casePortView(portView);
				if (result == null) result = casePort(portView);
				if (result == null) result = caseViewObject(portView);
				if (result == null) result = casePosition(portView);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.VIEW_OBJECT: {
				ViewObject viewObject = (ViewObject)theEObject;
				T result = caseViewObject(viewObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.VIEW_LINK: {
				ViewLink viewLink = (ViewLink)theEObject;
				T result = caseViewLink(viewLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.FAILURE_VIEW: {
				FailureView failureView = (FailureView)theEObject;
				T result = caseFailureView(failureView);
				if (result == null) result = caseFailure(failureView);
				if (result == null) result = caseViewObject(failureView);
				if (result == null) result = casePosition(failureView);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.SYSTEM_VIEW: {
				SystemView systemView = (SystemView)theEObject;
				T result = caseSystemView(systemView);
				if (result == null) result = caseGeneralizedNet(systemView);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Port View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Port View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePortView(PortView object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseViewObject(ViewObject object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Failure View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Failure View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFailureView(FailureView object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Generalized Net</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Generalized Net</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGeneralizedNet(GeneralizedNet object) {
		return null;
	}
